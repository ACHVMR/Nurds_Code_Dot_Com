-- Make nullable all columns that should allow NULL for system/premade agents
ALTER TABLE boomer_angs ALTER COLUMN user_id DROP NOT NULL;
ALTER TABLE boomer_angs ALTER COLUMN ceremonial_name DROP NOT NULL;
ALTER TABLE boomer_angs ALTER COLUMN agent_type DROP NOT NULL;
...
ALTER TABLE boomer_angs ADD COLUMN IF NOT EXISTS creator_id UUID;
...
-- Insert the 8 premade Boomer_Angs with all required fields
INSERT INTO boomer_angs (name, description, image_url, category, effectiveness_level, features, tags, is_premade, is_public, config, user_id, ceremonial_name, agent_type) VALUES
(
  'Code Review Expert',
...
-- Verify the insert
SELECT name, effectiveness_level, category, agent_type, is_premade FROM boomer_angs WHERE is_premade = true;
