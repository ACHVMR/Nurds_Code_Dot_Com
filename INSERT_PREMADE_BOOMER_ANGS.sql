-- Make nullable columns that are required to be NOT NULL but should allow NULL for system agents
...
-- Insert the 8 premade Boomer_Angs
INSERT INTO boomer_angs (name, description, image_url, category, effectiveness_level, features, tags, is_premade, is_public, config, user_id, ceremonial_name) VALUES
(
  'Code Review Expert',
...
-- Verify the insert
SELECT name, effectiveness_level, category, is_premade FROM boomer_angs WHERE is_premade = true;
