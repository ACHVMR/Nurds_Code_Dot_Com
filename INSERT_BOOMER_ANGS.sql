-- Clear existing premade Boomer_Angs (optional, remove if you want to keep existing ones)
DELETE FROM boomer_angs WHERE is_premade = true;

-- Insert 8 Premade Boomer_Angs
