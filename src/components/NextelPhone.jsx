    ...
    <div className="nextel-phone-container fixed bottom-8 right-8 z-40 pointer-events-none">
      ...
      <div className={`relative transition-all duration-700 ease-in-out pointer-events-auto`} style={{ height: isOpen ? '640px' : '180px', width: '320px' }}>
        ...
        <div className="relative w-full h-full">
          ...
          <div
            className={`absolute inset-x-0 top-0 bg-gradient-to-b from-black to-gray-900 border-2 border-[#E68961] rounded-t-3xl transition-all duration-700 ease-in-out shadow-[0_0_20px_rgba(230,137,97,0.3)] cursor-pointer hover:shadow-[0_0_30px_rgba(230,137,97,0.5)]`}
            style={{
              ...
              <div className="border-t border-[#E68961]/30 p-3 bg-gray-900">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-[#E68961] hover:bg-[#D4A05F] flex items-center justify-center transition-colors flex-shrink-0"
                  >
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-gray-800 hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors flex-shrink-0"
                  >
