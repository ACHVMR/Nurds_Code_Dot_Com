-- Make user_id nullable for system/premade Boomer_Angs
...
-- Insert the 8 premade Boomer_Angs (user_id can be NULL for system agents)
INSERT INTO boomer_angs (name, description, image_url, category, effectiveness_level, features, tags, is_premade, is_public, config, user_id) VALUES
(
  'Code Review Expert',
